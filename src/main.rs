...
fn main() {
    ...
    let dot_file = matches.value_of("dot file").unwrap_or("dot-files/output.dot");
    ...
    let write_file = File::create(write_path).expect("Could not create file for the Partition instance");
